...
class EditProduct extends React.Component {
    ...
    async searchItemProduct() {
        ...
        for (var i = 0; i < this.state.search.length; i++) {
            if (this.state.search[i].name === "mobileNumber") {
            ...
            } else if (this.state.search[i].name === "paymentId") {
                data.paymentId = this.state.search[i].value;
                ...
                <div dir="rtl">
                    <Card>
                        <CardHeader plain color="primary">
                            <h4 className={classes.cardTitleWhite}>گزارش قبض</h4>
                        </CardHeader>
                        <CardBody
                            style={{
